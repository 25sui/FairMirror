...
def audit_jd(title: str, content: str) -> JDAuditResponse:
    ...
    replacements = {
        "35岁以下": "具备岗位所需经验与交付能力",
        "18-24岁": "具备岗位所需基础能力和学习能力",
        "19-40周岁": "具备岗位所需服务能力和客户沟通经验",
        "30岁一45岁": "具备行政协同、材料处理和会议组织经验",
        "本科及以上": "具备岗位所需知识或等效项目经验",
        "大专及以上": "具备岗位所需知识或等效实践经验",
        "中专/中技及以上": "具备岗位所需技能或等效服务经验",
        "985/211": "具备相关专业知识或等效项目经验",
        "党员优先": "具备合规意识、组织协调和材料处理能力者优先",
        "女士优先": "具备客户沟通能力和门店服务经验者优先",
        "形象良好": "具备专业服务意识和清晰沟通能力",
        "抗压能力强": "能在明确目标和资源支持下推进复杂任务",
        "高强度加班": "能适应阶段性业务高峰并获得调休支持",
        "接受加班": "能适应阶段性业务高峰并获得相应补偿或调休支持",
        "吃苦耐劳": "具备稳定执行和问题跟进能力",
        "长期稳定": "能与岗位周期和业务节奏匹配",
        "非诚勿扰": "请候选人结合岗位要求评估匹配度后投递",
        "狼性": "目标感强、协作推进能力好",
        "本地户籍": "可稳定满足岗位所在城市工作安排",
        "本地优先": "能稳定满足岗位所在城市工作安排者优先",
        "洛阳或周边居住": "能满足洛阳工作地点和通勤安排",
    }
